...
const circle = {
  ...
  id: 'tikz:circle',
  library: 'tikz',
  type: 'circle', // nome do tipo usado no registry
  label: 'Circle',
  category: 'shape',
  defaults: {
    x: 1,
...
// ✅ registra passando (type: string, descriptor: objeto)
elementRegistry.register(circle.type, circle);
console.log('✅ circle registrado:', circle.type);
